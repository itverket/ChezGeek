...
namespace ChezGeek.UI.ViewModels
{
    public class Chessboard : ObservableObject
    {
        ...
        public ICollection<string> WhiteMoveHistory { get; set; }
        public ICollection<string> BlackMoveHistory { get; set; }
        public ChessPlayerModel WhitePlayer { get; set; }
        public ChessPlayerModel BlackPlayer { get; set; }
        public List<float> PerceivedStrengthHistory { get; set; }

        private void Reset()
        {
            _tiles.Clear();
            PerceivedStrengthHistory = new List<float>();
            var tileColor = TileColor.Light;
            ...
            ChessRow[] rowHeaders =
{
            ...
            WhiteMoveHistory = new List<string>();
            BlackMoveHistory = new List<string>();
        }
