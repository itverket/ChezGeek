...
namespace ChezGeek.Common.Actors
{
    public class BoardActor : ReceiveActor
    {
        ...
        private async Task<ChessBoardStateViewModel> Step()
        {
            ...
            var viewmodel = new ChessBoardStateViewModel(_chessBoardState, move.PerceivedStrength);
            viewmodel.EndResult = _chessBoardState.NextToMove == Player.White ? StateResult.WhiteIllegalMove : StateResult.BlackIllegalMove;
            return viewmodel;
