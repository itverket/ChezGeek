    ...
    public partial class ChessboardUserControl
    {
        ...
        private async Task RunGameAsync(bool untilDone)
        {
            ...
            while (true)
            {
                ...
                SetPlayerTime();
                UpdateStrengthGraph();
                if (untilDone && _chessBoardState.EndResult == null && !_stopRun)
                {
                    continue;
                }
        ...
        private string GetEndResultString(ChessBoardStateViewModel chessBoardState)
        {
            ...
            switch (chessBoardState.EndResult)
            {
                    ...
                    return "White Player won! Black player was out of time!";
                case StateResult.BlackKingChecked:
                    return "White Player won! Black player's king was checked!???";
                    case StateResult.BlackKingCheckmated:
                    return "White Player won! Black player's king was checkmated!";
                ...
                case StateResult.WhiteIsOutOfTime:
                    return "Black player won! White player was out of time!";
                case StateResult.WhiteKingChecked:
                    return "Black Player won! White player's king was checked!???";
                case StateResult.WhiteKingCheckmated:
                    return "Black Player won! White player's king was checkmated!";
                default:
